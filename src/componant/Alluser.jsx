...
// //               <td>{user.time}</td>
// //               <td>
// //                 <Link to={`/update/${user.mobail}`} className="btn btn-sm btn-primary mx-2">Update</Link>
// //               </td>
// //             </tr>
// //           ))}
// //         </tbody>
...
//                   type="text" 
//                   name="dayName" 
//                   value={selectedUser.dayName} 
//                   onChange={handleInputChange} 
//                 />
//               </div>
//               <div className="form-group">
//                 <label>Naivadya Type:</label>
//                 <input 
//                   type="text" 
//                   name="naivadyaType" 
//                   value={selectedUser.naivadyaType} 
//                   onChange={handleInputChange} 
//                 />
//               </div>
//               <div className="form-group">
//                 <label>Aarati Time:</label>
//                 <input 
//                   type="text" 
//                   name="time" 
//                   value={selectedUser.time} 
//                   onChange={handleInputChange} 
//                 />
//               </div>
